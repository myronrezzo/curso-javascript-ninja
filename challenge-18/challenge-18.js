(function(){
	...
	*/
	...
	console.log ( meses.match (/j.{3}o/g) );
	...
	*/
	...
	var tagsAbertura = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
	console.log ( tagsAbertura.match (/<\w+>/g) );
	...
	*/
	...
	var tagsVazias = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
	console.log ( tagsVazias.match (/<\w+><\/\w+>/g) );
